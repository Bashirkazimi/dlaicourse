...
function getModel() {
    ...
    // YOUR CODE HERE
    model.add(tf.layers.conv2d({inputShape: [28, 28, 1], kernelSize: 3, filters: 128, activation: 'relu'}))
    model.add(tf.layers.maxPooling2d({poolSize: [2,2]}))
    model.add(tf.layers.conv2d({kernelSize: 3, filters: 64, strides:1, activation: 'relu'}))
    model.add(tf.layers.conv2d({kernelSize: 3, filters: 32, strides:1, activation: 'relu'}))
